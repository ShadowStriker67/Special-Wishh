...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Live Age Counter ---
    const birthDate = new Date('1985-06-14T00:00:00');
...
function enterSite() {
  ...
  // start music on interaction (browser requirement)
  music.volume = 0.8;
  music.play();
...
const surprises = [
    "🚨 You are officially a BAD GIRL!",
    "😤 You deserve... Very very hard spankings!",
    "👑 Potrebujes vysprasky !",
    "🍔 Fine: one hug... AFTER you apologize.",
    "🐧 You owe me unlimited cuddles.",
    "😏 Being cute doesn't erase your crimes.",
    "💖 Sentence: 100 forehead kisses.",
    "🎮 Punishment: Gime me BJ 🤣",
    "🍫 HUG ME FASTT",
    "❤️ You're guilty of stealing my heart.",
    "I will bite your ass, Lucieeeee.",
...
function showSurprise() {
    ...
    document.getElementById("surprisePopup").classList.add("flex");
}

function closeSurprise() {
    document.getElementById("surprisePopup").classList.remove("flex");
